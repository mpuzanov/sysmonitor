...
type DiskResponse struct {
	...
	Fs        []*DiskFS            `protobuf:"bytes,3,rep,name=fs,proto3" json:"fs,omitempty"` //repeated DiskFS fsInode = 4;
}
...
var file_sysmonitor_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x04, 0x69, 0x64, 0x6c, 0x65, 0x22, 0x95, 0x01, 0x0a, 0x06,
	...
	0x73, 0x6b, 0x46, 0x53, 0x52, 0x02, 0x66, 0x73, 0x32, 0x36, 0x0a, 0x0a, 0x53, 0x79, 0x73, 0x6d,
	0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x12, 0x28, 0x0a, 0x07, 0x53, 0x79, 0x73, 0x49, 0x6e, 0x66,
	0x6f, 0x12, 0x0c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x0b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x30, 0x01,
...
var file_sysmonitor_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_sysmonitor_proto_depIdxs = []int32{
	7, // 0: api.SystemResponse.query_time:type_name -> google.protobuf.Timestamp
	7, // 1: api.CPUResponse.query_time:type_name -> google.protobuf.Timestamp
	...
	7, // 5: api.DiskResponse.query_time:type_name -> google.protobuf.Timestamp
	4, // 6: api.DiskResponse.io:type_name -> api.DiskIO
	5, // 7: api.DiskResponse.fs:type_name -> api.DiskFS
	0, // 8: api.Sysmonitor.SysInfo:input_type -> api.Request
	3, // 9: api.Sysmonitor.SysInfo:output_type -> api.Result
